  ...
  const fetchBalanceDetail = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/api/balanceHistory/${balanceHistoryId}`,
        {
          headers: {
...
Mô tả: ${detail.description}
      ...
      <SafeAreaView style={styles.emptyContainer}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.emptyText}>
            Thông tin giao dịch này không tồn tại hoặc đã bị xóa
          </Text>
          <TouchableOpacity
  ...
  return (
    ...
    >
      <StatusBar
        barStyle="dark-content"
        backgroundColor={statusInfo.statusBarColor}
      />

      {/* Header */}
      <View
        style={[styles.header, { backgroundColor: statusInfo.statusBarColor }]}
      >
        <TouchableOpacity
          onPress={() => navigation.goBack()}
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoValue}>
              {formatAmount(detail.previousBalance)}
            </Text>
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoValue}>
              {formatAmount(detail.currentBalance)}
            </Text>
          </View>
