    ...
    const renderItem = ({ item }) => (
        <View style={styles.itemContainer}>
            <View style={styles.headerContainer}>
                ...
                <View style={[styles.statusBadge, item.status === 'Waiting for delivery' ? styles.waitingStatus : styles.activeStatus]}>
            ...
            <View style={styles.capacityContainer}>
                ...
                <Text style={styles.capacityText}>Sức Chứa: {item.availableCapacity} Kg</Text>
            </View>
